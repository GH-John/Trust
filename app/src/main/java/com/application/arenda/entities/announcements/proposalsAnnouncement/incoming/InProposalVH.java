...
public class InProposalVH extends BaseViewHolder {
    ...
    @BindView(R.id.btnAcceptProposal)
    Button btnAcceptProposal;
    ...
    public static InProposalVH create(ViewGroup parent) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.vh_incoming_proposal, parent, false);
        return new InProposalVH(view);
    }

    @Override
    public int getResourceLayoutId() {
        return R.layout.vh_incoming_proposal;
    }
    ...
    public void setBtnAcceptListener(OnItemClick itemClick) {
        if (itemClick == null)
            return;
