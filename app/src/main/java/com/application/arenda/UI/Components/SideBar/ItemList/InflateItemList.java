...
public final class InflateItemList {
    public static List<ContentItemList> getItemListData(Drawable drawable){
        ...
        contentItemLists.add(new ContentItemList(FragmentAllAnnouncements.getInstance(),R.string.itemList_all_announcements, R.drawable.sb_item_search_announcements, drawable));
        contentItemLists.add(new ContentItemList(FragmentUserAnnouncements.getInstance(), R.string.itemList_user_announcements, R.drawable.sb_item_user_announcements, drawable));
        contentItemLists.add(new ContentItemList(FragmentUserProposals.getInstance(), R.string.itemList_proposals, R.drawable.sb_item_proposals, drawable));
