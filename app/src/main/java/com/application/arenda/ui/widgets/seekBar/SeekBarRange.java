...
import com.application.arenda.ui.widgets.seekBar.interfaces.OnRangeSeekbarFinalValueListener;
...
public class SeekBarRange extends View {
    ...
    private SeekBarRange.Thumb pressedThumb;
    ...
    public SeekBarRange(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        // prevent render is in edit mode
        if (isInEditMode()) return;

        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SeekbarSingleAndRange);
        try {
    ...
    public SeekBarRange setCornerRadius(float cornerRadius) {
    ...
    public SeekBarRange setMinValue(float minValue) {
    ...
    public SeekBarRange setMaxValue(float maxValue) {
        this.maxValue = maxValue;
        this.absoluteMaxValue = maxValue;
        return this;
    }

    public SeekBarRange setMinStartValue(float minStartValue) {
        this.minStartValue = minStartValue;
        this.absoluteMinStartValue = minStartValue;
        return this;
    }

    public SeekBarRange setMaxStartValue(float maxStartValue) {
        this.maxStartValue = maxStartValue;
        this.absoluteMaxStartValue = maxStartValue;
        return this;
    }

    public SeekBarRange setSteps(float steps) {
        this.steps = steps;
        return this;
    }

    public SeekBarRange setGap(float gap) {
        this.gap = gap;
        return this;
    }

    public SeekBarRange setFixGap(float fixGap) {
        this.fixGap = fixGap;
        return this;
    }

    public SeekBarRange setBarColor(int barColor) {
        this.barColor = barColor;
        return this;
    }

    public SeekBarRange setBarHighlightColor(int barHighlightColor) {
        this.barHighlightColor = barHighlightColor;
        return this;
    }

    public SeekBarRange setLeftThumbColor(int leftThumbColorNormal) {
        this.leftThumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public SeekBarRange setLeftThumbHighlightColor(int leftThumbColorPressed) {
        this.leftThumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public SeekBarRange setLeftThumbDrawable(int resId) {
        setLeftThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SeekBarRange setLeftThumbDrawable(Drawable drawable) {
        setLeftThumbBitmap(getBitmap(drawable));
        return this;
    }

    public SeekBarRange setLeftThumbBitmap(Bitmap bitmap) {
        leftThumb = bitmap;
        return this;
    }

    public SeekBarRange setLeftThumbHighlightDrawable(int resId) {
        setLeftThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SeekBarRange setLeftThumbHighlightDrawable(Drawable drawable) {
        setLeftThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public SeekBarRange setLeftThumbHighlightBitmap(Bitmap bitmap) {
        leftThumbPressed = bitmap;
        return this;
    }

    public SeekBarRange setRightThumbColor(int rightThumbColorNormal) {
        this.rightThumbColorNormal = rightThumbColorNormal;
        return this;
    }

    public SeekBarRange setRightThumbHighlightColor(int rightThumbColorPressed) {
        this.rightThumbColorPressed = rightThumbColorPressed;
        return this;
    }

    public SeekBarRange setRightThumbDrawable(int resId) {
        setRightThumbDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SeekBarRange setRightThumbDrawable(Drawable drawable) {
        setRightThumbBitmap(getBitmap(drawable));
        return this;
    }

    public SeekBarRange setRightThumbBitmap(Bitmap bitmap) {
        rightThumb = bitmap;
        return this;
    }

    public SeekBarRange setRightThumbHighlightDrawable(int resId) {
        setRightThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public SeekBarRange setRightThumbHighlightDrawable(Drawable drawable) {
        setRightThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public SeekBarRange setRightThumbHighlightBitmap(Bitmap bitmap) {
        rightThumbPressed = bitmap;
        return this;
    }

    public SeekBarRange setDataType(int dataType) {
    ...
    protected SeekBarRange.Thumb getPressedThumb() {
        return pressedThumb;
    }
    ...
    protected float getCornerRadius(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_min_start_value, minValue);
    }

    protected float getMaxStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_max_start_value, maxValue);
    }

    protected float getSteps(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_steps, NO_STEP);
    }

    protected float getGap(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_gap, 0f);
    }

    protected float getFixedGap(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.SeekbarSingleAndRange_fix_gap, NO_FIXED_GAP);
    }

    protected int getBarColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SeekbarSingleAndRange_bar_color, Color.GRAY);
    }

    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SeekbarSingleAndRange_bar_highlight_color, Color.BLACK);
    }

    protected int getLeftThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SeekbarSingleAndRange_left_thumb_color, Color.BLACK);
    }

    protected int getRightThumbColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SeekbarSingleAndRange_right_thumb_color, Color.BLACK);
    }

    protected int getLeftThumbColorPressed(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SeekbarSingleAndRange_left_thumb_color_pressed, Color.DKGRAY);
    }

    protected int getRightThumbColorPressed(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.SeekbarSingleAndRange_right_thumb_color_pressed, Color.DKGRAY);
    }

    protected Drawable getLeftDrawable(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.SeekbarSingleAndRange_left_thumb_image);
    }

    protected Drawable getRightDrawable(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.SeekbarSingleAndRange_right_thumb_image);
    }

    protected Drawable getLeftDrawablePressed(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.SeekbarSingleAndRange_left_thumb_image_pressed);
    }

    protected Drawable getRightDrawablePressed(final TypedArray typedArray) {
        return typedArray.getDrawable(R.styleable.SeekbarSingleAndRange_right_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.SeekbarSingleAndRange_data_type, SeekBarRange.DataType.INTEGER);
    }
    ...
    protected void setupLeftThumb(final Canvas canvas, final Paint paint, final RectF rect) {
        leftThumbColor = (SeekBarRange.Thumb.MIN.equals(pressedThumb)) ? leftThumbColorPressed : leftThumbColorNormal;
        ...
        if (leftThumb != null) {
            Bitmap lThumb = (SeekBarRange.Thumb.MIN.equals(pressedThumb)) ? leftThumbPressed : leftThumb;
    ...
    protected void setupRightThumb(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        rightThumbColor = (SeekBarRange.Thumb.MAX.equals(pressedThumb)) ? rightThumbColorPressed : rightThumbColorNormal;
        ...
        if (rightThumb != null) {
            Bitmap rThumb = (SeekBarRange.Thumb.MAX.equals(pressedThumb)) ? rightThumbPressed : rightThumb;
    ...
    protected void trackTouchEvent(MotionEvent event) {
        ...
        try {
            ...
            if (SeekBarRange.Thumb.MIN.equals(pressedThumb)) {
                setNormalizedMinValue(screenToNormalized(x));
            } else if (SeekBarRange.Thumb.MAX.equals(pressedThumb)) {
    ...
    private SeekBarRange.Thumb evalPressedThumb(float touchX) {
        SeekBarRange.Thumb result = null;

        boolean minThumbPressed = isInThumbRange(touchX, normalizedMinValue);
        boolean maxThumbPressed = isInThumbRange(touchX, normalizedMaxValue);
        if (minThumbPressed && maxThumbPressed) {
            // if both thumbs are pressed (they lie on top of each other), choose the one with more room to drag. this avoids "stalling" the thumbs in a corner, not being able to drag them apart anymore.
            result = (touchX / getWidth() > 0.5f) ? SeekBarRange.Thumb.MIN : SeekBarRange.Thumb.MAX;
        } else if (minThumbPressed) {
            result = SeekBarRange.Thumb.MIN;
        } else if (maxThumbPressed) {
            result = SeekBarRange.Thumb.MAX;
        }
        return result;
    }
    ...
    private <T extends Number> Number formatValue(T value) throws IllegalArgumentException {
        ...
        if (dataType == SeekBarRange.DataType.LONG) {
            return v.longValue();
        }
        if (dataType == SeekBarRange.DataType.DOUBLE) {
            return v;
        }
        if (dataType == SeekBarRange.DataType.INTEGER) {
            return Math.round(v);
        }
        if (dataType == SeekBarRange.DataType.FLOAT) {
            return v.floatValue();
        }
        if (dataType == SeekBarRange.DataType.SHORT) {
            return v.shortValue();
        }
        if (dataType == SeekBarRange.DataType.BYTE) {
            return v.byteValue();
        }
